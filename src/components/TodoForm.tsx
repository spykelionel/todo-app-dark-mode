...
const TodoForm: React.FC<TodoFormProps> = ({ 
  ...
  const [priority, setPriority] = useState<Priority>(initialValues?.priority || null);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-gray-800 rounded-lg p-4 shadow-md">
      <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="w-full sm:w-1/2">
          ...
          <div className="relative">
            ...
            >
              <span className={`inline-flex items-center ${priority ? priorityColorMap[priority] : 'text-gray-600 dark:text-gray-300'}`}>
              ...
              <div className="absolute left-0 right-0 mt-1 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md shadow-lg z-10">
                <div className="py-1">
                  {['high', 'medium', 'low', null].map((p) => (
                    ...
                    >
                      <span className={p ? priorityColorMap[p as Priority] : 'text-gray-600 dark:text-gray-300'}>
